    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-gray-100 overflow-hidden pt-20">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="py-20 px-4 sm:px-6 lg:px-8" id="features">
          <h2 className="text-4xl font-bold mb-16 text-center text-white animate-fade-in-up">
            ...
            {[
              {
                ...
                icon: <TwitterIcon className="w-12 h-12 sm:w-16 sm:h-16 mb-6 text-blue-400" />,
                description:
                  "Generate compelling Twitter threads that captivate your audience, spark meaningful discussions, and boost your reach and engagement.",
              },
              {
                title: "Instagram Captions",
                icon: (
                  <InstagramIcon className="w-12 h-12 sm:w-16 sm:h-16 mb-6 text-pink-400" />
                ),
                description:
                  "Create eye-catching captions for your Instagram posts that resonate with followers, increase engagement, and attract new audiences.",
              },
              {
                title: "LinkedIn Posts",
                icon: <LinkedinIcon className="w-12 h-12 sm:w-16 sm:h-16 mb-6 text-blue-600" />,
                description:
                  "Craft professional, insightful content for your LinkedIn network to establish thought leadership and expand your professional influence.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 shadow-lg hover:shadow-2xl transition duration-500 ease-in-out transform hover:-translate-y-2 hover:scale-105 animate-fade-in-up"
                style={{ animationDelay: `${index * 150}ms` }}
              >
                <div className="flex flex-col items-center text-center">
                  <div className="mb-6 transition-transform duration-300 ease-in-out transform hover:scale-110">
                    {feature.icon}
                  </div>
        ...
        {/* Benefits Section */}
        <div className="py-20 bg-gradient-to-br from-gray-900 to-blue-900 rounded-3xl my-20 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="bg-white bg-opacity-10 rounded-xl p-6 transform transition duration-500 hover:scale-105">
