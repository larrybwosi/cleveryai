...
import { generateContentServer } from "@/actions/creation";
...
export default function GenerateContent() {
  ...
  const [userPoints, setUserPoints] = useState<number | null>(5);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { content, updatedUser, savedContent } = await generateContentServer(
        user.id,
        contentType,
        prompt,
        imageData
